...
export const TerminalPanel: FC<TerminalPanelProps> = ({
  ...
  return (
    <div
      className={`border-t border-[var(--color-border)] flex flex-col ${fillContainer ? 'flex-1 min-h-0 border-t-0 bg-[var(--color-bg-base)]' : 'shrink-0'} ${isFullscreen ? 'absolute inset-0 z-50 border-t-0 bg-[var(--color-bg-base)]' : ''}`}
