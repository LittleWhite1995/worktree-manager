  ...
  return (
    <ToastProvider>
      <div className="relative h-full w-full flex flex-col overflow-hidden">
        ...
        {closable && onClose && (
          <button
            ...
            className="absolute top-1 right-1 z-30 w-4 h-4 rounded-sm flex items-center justify-center
                       text-[#55556A] bg-[#141419]/60 opacity-0 group-hover/cell:opacity-100
        ...
        <div
          className="h-full bg-[#0A0A0F] text-[#E8E8ED] p-6 overflow-y-auto"
        ...
        {/* Main View (desktop) */}
        <div
          className="h-full bg-[#0A0A0F] text-[#E8E8ED] flex overflow-hidden"
