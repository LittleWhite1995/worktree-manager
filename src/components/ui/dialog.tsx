...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-[#0A0A0F] transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:ring-offset-2 disabled:pointer-events-none text-[#8B8B9E] data-[state=open]:bg-transparent data-[state=open]:text-[#8B8B9E]">
        <X className="h-4 w-4" />
